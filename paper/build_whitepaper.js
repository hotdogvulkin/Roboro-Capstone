...
const doc = new Document({
  ...
  sections:[{
    ...
    body('Based on 651 verified state-fiscal-years. Analysis runs FY2015–FY2027; one earlier record (New Jersey FY2014) sits in the dataset and is excluded from every statistic.',{size:21,color:MUTED,after:300}),
